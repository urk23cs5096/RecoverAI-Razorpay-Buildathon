...
3. **Physical Simulation Impact**: When tested in full physical rails simulation on 1,500 test transactions (₹3.64 Cr at risk), RecoverAI's multi-rail policy recovered **₹2.99 Cr (82.3% revenue recovery rate, 76.5% transaction count: 1,147/1,500)** compared to **₹62.3 Lakhs (17.1% revenue rate, 17.9% transaction count: 269/1,500)** for standard Rule-Based dunning and **₹19.7 Lakhs (5.4% revenue rate, 5.7% transaction count: 85/1,500)** for Naive 3x auto-retries—with multi-seed validation proving an overwhelming **+₹2.37 Cr Macro Net Lift ($p = 4.09 \times 10^{-45}$)** across 30 seeds.
